...
const skills = [
  ...
  { name: "Socky", value: 80, icon: <SiFigma /> },
  { name: "Canva", value: 85, icon: <FaNetworkWired /> },
  { name: "HR", value: 75, icon: <FaUsers /> },
];
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between gap-12 relative z-10">
        {/* Profilová fotka a efekty na tablet a mobil */}
        <div className="lg:hidden relative flex flex-col items-center mb-8">
          {/* Motion koule */}
          <motion.div
        ...
        <h2
  className="text-4xl lg:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-blue-500 to-blue-600 leading-normal"
>
  Martin Andrt
</h2>
        ...
        {/* Pravý blok - Profilová fotka a efekty na desktop */}
        <div className="hidden lg:flex relative lg:w-1/2 flex-col items-center">
          {/* Motion koule */}
          <motion.div
            className="absolute w-64 h-64 md:w-96 md:h-96 bg-blue-500 rounded-full opacity-30 blur-3xl"
            animate={{
